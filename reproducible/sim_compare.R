...
na_lag_pairs = function (x, missing_idx, h = 1) {
  # Find pairs that are h steps away and at least one of them is missing
  ...
  for (i in missing_idx) {
    if (i - h > 0) {
      res[counter,] = c(x[i - h], x[i])
      counter = counter + 1
    } 
    if (i + h < n + 1) {
      res[counter,] = c(x[i], x[i + h])
      counter = counter + 1
    }
  }
  
  return (res[1:(counter - 1),])
}
...
for (sim in 1:1000) {
  ...
  if (sim == 1) {
    ...
    df1 = data.frame(x = embed(dta, 3)[,3], y = embed(dta, 3)[,1])
    p1 = ggplot(df1, aes(x = x, y = y)) +
      coord_cartesian(xlim = plot_range, ylim = plot_range) +
      geom_point(color = "steelblue", size = 1) +
      theme_minimal() +
      labs(title = "Ground truth", x = "x_{t-2}", y = "x_t")
    
    temp = na_lag_pairs(lin, which(is.na(x_obs[,1])), h = 2)
    temp = data.frame(x = temp[,1],
                      y = temp[,2])
    p2 = ggplot(temp, aes(x = x, y = y)) + 
      geom_point(color = "steelblue1", size = 1) +
    ...
    temp = na_lag_pairs(SSA, which(is.na(x_obs[,1])), h = 2)
    temp = data.frame(x = temp[,1],
                      y = temp[,2])
    p3 = ggplot(temp, aes(x = x, y = y)) +
      geom_point(color = "steelblue1", size = 1) +
    ...
    temp = na_lag_pairs(Kalman, which(is.na(x_obs[,1])), h = 2)
    temp = data.frame(x = temp[,1],
                      y = temp[,2])
    p4 = ggplot(temp, aes(x = x, y = y)) + 
      geom_point(color = "steelblue1", size = 1) +
    ...
    temp = na_lag_pairs(PT, which(is.na(x_obs[,1])), h = 2)
    temp = data.frame(x = temp[,1],
                      y = temp[,2])
    p5 = ggplot(temp, aes(x = x, y = y)) + 
      geom_point(color = "steelblue1", size = 1) +
    ...
    temp = na_lag_pairs(wass, which(is.na(x_obs[,1])), h = 2)
    temp = data.frame(x = temp[,1],
                      y = temp[,2])
    p6 = ggplot(temp, aes(x = x, y = y)) + 
      geom_point(color = "steelblue1", size = 1) +
    ...
    temp = na_lag_pairs(kwass, which(is.na(x_obs[,1])), h = 2)
    temp = data.frame(x = temp[,1],
                      y = temp[,2])
    p7 = ggplot(temp, aes(x = x, y = y)) + 
      geom_point(color = "steelblue1", size = 1) +
    ...
    temp = na_lag_pairs(wass_Kalman, which(is.na(x_obs[,1])), h = 2)
    temp = data.frame(x = temp[,1],
                      y = temp[,2])
    p8 = ggplot(temp, aes(x = x, y = y)) + 
      geom_point(color = "steelblue1", size = 1) +
    ...
    temp = na_lag_pairs(kwass_Kalman, which(is.na(x_obs[,1])), h = 2)
    temp = data.frame(x = temp[,1],
                      y = temp[,2])
    p9 = ggplot(temp, aes(x = x, y = y)) + 
      geom_point(color = "steelblue1", size = 1) +
  ...
  if (sim == 1) {
    ...
    df1 = data.frame(x = embed(dta, 7)[,7], y = embed(dta, 7)[,1])
    p1 = ggplot(df1, aes(x = x, y = y)) +
      coord_cartesian(xlim = plot_range, ylim = plot_range) +
      geom_point(color = "steelblue", size = 1) +
      theme_minimal() +
      labs(title = "Ground truth", x = "x_{t-6}", y = "x_t")
    
    temp = na_lag_pairs(lin, which(is.na(x_obs[,1])), h = 6)
    temp = data.frame(x = temp[,1],
                      y = temp[,2])
    p2 = ggplot(temp, aes(x = x, y = y)) + 
      geom_point(color = "steelblue1", size = 1) +
    ...
    temp = na_lag_pairs(SSA, which(is.na(x_obs[,1])), h = 6)
    temp = data.frame(x = temp[,1],
                      y = temp[,2])
    p3 = ggplot(temp, aes(x = x, y = y)) +
      geom_point(color = "steelblue1", size = 1) +
    ...
    temp = na_lag_pairs(Kalman, which(is.na(x_obs[,1])), h = 6)
    temp = data.frame(x = temp[,1],
                      y = temp[,2])
    p4 = ggplot(temp, aes(x = x, y = y)) + 
      geom_point(color = "steelblue1", size = 1) +
    ...
    temp = na_lag_pairs(PT, which(is.na(x_obs[,1])), h = 6)
    temp = data.frame(x = temp[,1],
                      y = temp[,2])
    p5 = ggplot(temp, aes(x = x, y = y)) + 
      geom_point(color = "steelblue1", size = 1) +
    ...
    temp = na_lag_pairs(wass, which(is.na(x_obs[,1])), h = 6)
    temp = data.frame(x = temp[,1],
                      y = temp[,2])
    p6 = ggplot(temp, aes(x = x, y = y)) + 
      geom_point(color = "steelblue1", size = 1) +
    ...
    temp = na_lag_pairs(kwass, which(is.na(x_obs[,1])), h = 6)
    temp = data.frame(x = temp[,1],
                      y = temp[,2])
    p7 = ggplot(temp, aes(x = x, y = y)) + 
      geom_point(color = "steelblue1", size = 1) +
    ...
    temp = na_lag_pairs(wass_Kalman, which(is.na(x_obs[,1])), h = 6)
    temp = data.frame(x = temp[,1],
                      y = temp[,2])
    p8 = ggplot(temp, aes(x = x, y = y)) + 
      geom_point(color = "steelblue1", size = 1) +
    ...
    temp = na_lag_pairs(kwass_Kalman, which(is.na(x_obs[,1])), h = 6)
    temp = data.frame(x = temp[,1],
                      y = temp[,2])
    p9 = ggplot(temp, aes(x = x, y = y)) + 
      geom_point(color = "steelblue1", size = 1) +
  ...
  if (sim == 1) {
    ...
    df1 = data.frame(x = embed(dta, 11)[,11], y = embed(dta, 11)[,1])
    p1 = ggplot(df1, aes(x = x, y = y)) +
      coord_cartesian(xlim = plot_range, ylim = plot_range) +
      geom_point(color = "steelblue", size = 1) +
      theme_minimal() +
      labs(title = "Ground truth", x = "x_{t-10}", y = "x_t")
    
    temp = na_lag_pairs(lin, which(is.na(x_obs[,1])), h = 10)
    temp = data.frame(x = temp[,1],
                      y = temp[,2])
    p2 = ggplot(temp, aes(x = x, y = y)) + 
      geom_point(color = "steelblue1", size = 1) +
    ...
    temp = na_lag_pairs(SSA, which(is.na(x_obs[,1])), h = 10)
    temp = data.frame(x = temp[,1],
                      y = temp[,2])
    p3 = ggplot(temp, aes(x = x, y = y)) +
      geom_point(color = "steelblue1", size = 1) +
    ...
    temp = na_lag_pairs(Kalman, which(is.na(x_obs[,1])), h = 10)
    temp = data.frame(x = temp[,1],
                      y = temp[,2])
    p4 = ggplot(temp, aes(x = x, y = y)) + 
      geom_point(color = "steelblue1", size = 1) +
    ...
    temp = na_lag_pairs(PT, which(is.na(x_obs[,1])), h = 10)
    temp = data.frame(x = temp[,1],
                      y = temp[,2])
    p5 = ggplot(temp, aes(x = x, y = y)) + 
      geom_point(color = "steelblue1", size = 1) +
    ...
    temp = na_lag_pairs(wass, which(is.na(x_obs[,1])), h = 10)
    temp = data.frame(x = temp[,1],
                      y = temp[,2])
    p6 = ggplot(temp, aes(x = x, y = y)) + 
      geom_point(color = "steelblue1", size = 1) +
    ...
    temp = na_lag_pairs(kwass, which(is.na(x_obs[,1])), h = 10)
    temp = data.frame(x = temp[,1],
                      y = temp[,2])
    p7 = ggplot(temp, aes(x = x, y = y)) + 
      geom_point(color = "steelblue1", size = 1) +
    ...
    temp = na_lag_pairs(wass_Kalman, which(is.na(x_obs[,1])), h = 10)
    temp = data.frame(x = temp[,1],
                      y = temp[,2])
    p8 = ggplot(temp, aes(x = x, y = y)) + 
      geom_point(color = "steelblue1", size = 1) +
    ...
    temp = na_lag_pairs(kwass_Kalman, which(is.na(x_obs[,1])), h = 10)
    temp = data.frame(x = temp[,1],
                      y = temp[,2])
    p9 = ggplot(temp, aes(x = x, y = y)) + 
      geom_point(color = "steelblue1", size = 1) +
